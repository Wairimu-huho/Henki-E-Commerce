    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Henki</h3>
            <p className="mb-4">Your premier destination for high-quality products and exceptional shopping experience.</p>
          ...
          <div>
            ...
            <p className="mb-4">Subscribe to our newsletter for updates on new products and exclusive offers.</p>
            <form className="flex">
              <input
                type="email"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {currentYear} Henki E-Commerce. All rights reserved.</p>
